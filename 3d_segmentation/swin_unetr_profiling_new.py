# command line: "pip install monai==0.9.1; nsys profile --output /results/orig --force-overwrite true --trace-fork-before-exec true python3 swin_unetr_profiling.py --epochs 0 --val_epochs 0 --batch_size 1 --thread_workers False --num_workers 0"
...
#         Range()(ToDeviced(keys=["image", "label"], device=device)),
        Range()(EnsureTyped(keys=["image", "label"], device=device, track_meta=False)),
