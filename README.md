...
#### [endoscopy inbody classification](./computer_assisted_intervention/endoscopy_inbody_classification.ipynb)
Tutorial to show the pipeline of fine tuning an endoscopy inbody classification model based on a corresponding pretrained bundle in monai model zoo.
