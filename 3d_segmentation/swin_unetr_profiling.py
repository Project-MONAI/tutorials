# command line: "pip install nibabel==3.1.1; pip install tqdm==4.63.0; nsys profile --output /results/test_output --force-overwrite true --trace-fork-before-exec true python3 swin_unetr_profiling.py --epochs 5 --val_epochs 5 --batch_size 1 --thread_workers False --num_workers 0"
