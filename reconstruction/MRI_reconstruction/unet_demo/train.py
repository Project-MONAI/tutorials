...
def trainer(args):
    ...
    [
        ...
        ReferenceBasedNormalizeIntensityd(keys=["kspace_masked_ifft", "reconstruction_rss"], ref_key="kspace_masked_ifft", channel_wise=True),
    ...
    for epoch in range(args.num_epochs):
        ...
        for batch_data in train_loader:
            input, target, mean, std = batch_data["kspace_masked_ifft"], batch_data["reconstruction_rss"], batch_data["mean"], batch_data["std"]
