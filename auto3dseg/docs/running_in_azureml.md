...
It is possible to train Auto3dSeg using your the Azure Cloud. This page documents the minimal set up required to utilise Azure Machine Learning (AzureML) to run your Auto3dSeg training tasks.
...
Once the above configuration is completed, to run the Auto3dSeg AutoRunner in AzureML simply use the following command (in `azure_work_dir/`):
